...
const teachers = [
  ...
  },
  {
    ...
    experience: '15 yrs',
    boards: ['IB', 'IGCSE', 'SAT', 'A-Levels'],
    subjects: ['Organic Chem', 'Physical Chem', 'Inorganic'],
    students: 980,
    rating: 4.8,
    reviews: 287,
    bio: 'MIT graduate. Trained hundreds of students for IB Chemistry HL 7s and A-Level Chemistry distinctions.',
    avatar: '👨‍🏫',
    badge: 'IB & A-Level Expert',
  ...
  },
  {
    ...
    experience: '9 yrs',
    boards: ['IGCSE', 'ICSE', 'SAT'],
    subjects: ['Physics', 'Maths', 'Problem Solving'],
    students: 860,
    rating: 4.8,
    reviews: 215,
    bio: 'IIT Bombay alumnus. Trained 200+ students for IGCSE & SAT. Known for his structured problem-solving approach.',
    avatar: '👨‍🏫',
    badge: 'IGCSE & SAT Specialist',
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 256,
    bio: 'Research scientist turned educator. Produced multiple IB Biology 7 scorers and A-Level Biology distinctions.',
    avatar: '👩‍🏫',
    badge: 'IB & A-Level Bio Expert',
